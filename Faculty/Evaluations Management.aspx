<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Evaluations Management.aspx.cs" Inherits="db_projecta.Faculty.Evaluations_Management" %>
 ...
 <form id="form2" runat="server">
    ...
    <div>
        <asp:GridView ID="gvEvaluations" runat="server" AutoGenerateColumns="False">
            <Columns>
                <asp:BoundField DataField="student_id" HeaderText="Student ID" />
                <asp:BoundField DataField="evaluation_marks" HeaderText="Evaluation Marks" />
            </Columns>
        </asp:GridView>
    </div>
</form>
