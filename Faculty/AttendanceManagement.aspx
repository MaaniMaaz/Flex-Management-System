<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendanceManagement.aspx.cs" Inherits="db_projecta.Faculty.AttendanceManagement" %>
...
<body>
    ...
    <div class="form-container">
        ...
        <asp:Label ID="lblDate" runat="server" CssClass="current-date"></asp:Label>
        ...
        <asp:Label ID="Label1" runat="server" Text="" CssClass="success-message"></asp:Label>

        <div>
            <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlCourseCode_SelectedIndexChanged">
            </asp:DropDownList>
        </div>

        <div>
            <asp:DropDownList ID="DropDownList2" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged">
            </asp:DropDownList>
        </div>
        ...
        <div>
            <label>Date:</label>
            <asp:TextBox ID="txtDate" runat="server" CssClass="date-input"></asp:TextBox>
        </div>
        ...
        <div>
            <asp:Button ID="btnShowAttendance" runat="server" Text="Show Attendance" OnClick="btnShowAttendance_Click" />
        </div>
