<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="db_projecta.academic_office.Add" %>
   ...
   <style>
    ...
    <div class="form-container">
       <form id="formAddUser" runat="server">
        <div>
            <label for="ddlUserRole">Select User Role:</label>
        ...
        <div id="studentDetails" runat="server" visible="false">
            ...
            <div>
                ...
                <asp:TextBox ID="txtBatchYear" runat="server"></asp:TextBox>
            </div>
        </div>
        <div id="facultyDetails" runat="server" visible="false">
