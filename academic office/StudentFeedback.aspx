<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentFeedback.aspx.cs" Inherits="db_projecta.academic_office.StudentFeedback" %>
            ...
            <div class="sidebar">
                ...
                <div class="sidebar_inner">
                    ...
                    <ul class="siderbar_menu">
                        <li>
                            <a href="acadmicofficerHOME.aspx">
                                <div class="icon"><i class="fas fa-home"></i></div>
                                <div class="title">Home</div>
                            </a>
                        </li>
                        <li>
                            <a href="OfferedCourses.aspx">
                        ...
                        <li>
                            <a href="StudentSection.aspx">
                                ...
                                <div class="title">Student Section</div>
                            </a>
                        </li>
                        <li>
