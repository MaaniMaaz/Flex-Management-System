<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Attendance.aspx.cs" Inherits="db_projecta.academic_office.Attendance" %>
   ...
   <style>
    ...
    <form id="form2" runat="server">
        <div>
            ...
            <asp:Button ID="btnGetCourses" runat="server" Text="Get Courses" OnClick="btnGetCourses_Click" />
        </div>
        <hr />
        <div>
            <asp:DropDownList ID="ddlSections" runat="server" Visible="False"></asp:DropDownList>
            <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" Visible="False" />
        </div>
        <hr />
        <h2>Attendance Details</h2>
        <asp:GridView ID="gvAttendance" runat="server" AutoGenerateColumns="False" Visible="False">
            <Columns>
